...
<html lang="en">
    ...
    <body data-sidebar="dark">
        ...
        <div id="layout-wrapper">
            ...
            @include('layouts.location vendor.header')
            <!------- Sidebar Start ------->
            @include('layouts.location vendor.sidebar')
            <!---- Sidebar End ---->
            ...
            <div class="main-content">
                <div class="page-content">
                    @yield('location-vendor-content')
                </div>
                <!-- End Page-content -->

                
                @include('layouts.location vendor.footer')
        ...
        <!-- Right Sidebar -->
        @include('layouts.location vendor.rightSideBar')
        <!-- /Right-bar -->
