                                    ...
                                    <form method="POST" action="{{ route('user.detail.store') }}"
                                            ...
                                            <div class="col-md-10 m-auto">
                                                <label for="gender"
                                                    ...
                                                    <div class="form-check form-check-inline">
                                                      ...
                                                      <div class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="others" required>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-10 m-auto">
                                                ...
                                                <input id="features " type="text"
                                                    class="form-control @error('features') is-invalid @enderror"
                                                    name="features  " value="{{ old('body_typ') }}" required
                                                    autocomplete="features  " autofocus>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-10 m-auto">
                                                ...
                                                <input id="occupation " type="text"
                                                    ...
                                                    name="occupation  " value="{{ old('body_typ') }}" required
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-10 m-auto">
                                                ...
                                                <input id="residence " type="text"
                                                    ...
                                                    name="residence  " value="{{ old('body_typ') }}" required
