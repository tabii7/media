                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-8 write_profile profile_section hidden"
                                        ...
                                        <form method="POST" action="{{ route('writer.store') }}" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-10 m-auto">
                                                    <label for="fav_writers" class="col-form-label">{{ __('Fav Writers') }}</label>
                                                    <input id="fav_writers" type="text" class="form-control @error('fav_writers') is-invalid @enderror" name="fav_writers" value="{{ old('fav_writers') }}" required>
                                                    @error('fav_writers')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
